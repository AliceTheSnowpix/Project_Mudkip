...
//#endregion
//#region main
    } else if (arg === 'main' || cmd === '<@460159835544092674> help main') {
        let pages = ['Main Help Menu', 'Main Commands Descriptions']
        let page = 1;
        const mainembed = new bot.discord.MessageEmbed()
        .setColor('#FF00EC')
        .setTitle(pages[page-1])
            ...
            msg.react('614293189825789972').then( r => { 
              ...
              backwards.on('collect', r => { 
                 r.remove(message.author.id);
                    page--; 
                    if (page === 1) {
                        let mainembed = new bot.discord.MessageEmbed()
                        .setColor('#FF00EC')
                        .setDescription(`${prefix}${maincommands.join(`\n ${prefix}`)}`)
                        .setFooter(`Page ${page} of ${pages.length}`) 
                        .setTitle(pages[page-1])
...
//#endregion
//#region mod
    } else if (arg === 'mod' || cmd === '<@460159835544092674> help mod') {
            let pages = ['Moderation Help Menu', 'Moderation Commands Descriptions']
            let page = 1;
            const modembed = new bot.discord.MessageEmbed()
            .setColor('#FF00EC')
            .setTitle(pages[page-1])
                ...
                msg.react('614293189825789972').then( r => { 
                  ...
                  backwards.on('collect', r => { 
                     r.remove(message.author.id);
                        page--; 
                        if (page === 1) {
                            let modembed = new bot.discord.MessageEmbed()
                            .setColor('#FF00EC')
                            .setDescription(`${prefix}${modcommands.join(`\n ${prefix}`)}`)
                            .setFooter(`Page ${page} of ${pages.length}`) 
                            .setTitle(pages[page-1])
...
//#endregion
//#region fun
    } else if (arg === 'fun' || cmd === '<@460159835544092674> help fun') {
        let pages = ['Fun Help Menu', 'Fun Commands Descriptions'];
        let page = 1;
        const funembed = new bot.discord.MessageEmbed()
        .setColor('#FF00EC')
        .setTitle(pages[page-1])
            ...
            msg.react('614293189825789972').then( r => { 
              ...
              backwards.on('collect', r => { 
                 r.remove(message.author.id);
                    page--; 
                    if (page === 1) {
                        let funembed = new bot.discord.MessageEmbed()
                        .setColor('#FF00EC')
                        .setDescription(`${prefix}${funcommands.join(`\n ${prefix}`)}`)
                        .setFooter(`Page ${page} of ${pages.length}`) 
                        .setTitle(pages[page-1])
...
//#endregion
//#region economy
    } else if (arg === 'economy' || cmd === '<@460159835544092674> help economy') {
        let pages = ['Economy Help Menu', 'Economy Commands Descriptions'];
        let page = 1;
        const ecoembed = new bot.discord.MessageEmbed()
        .setColor('#FF00EC')
        .setTitle(pages[page-1])
            ...
            msg.react('614293189825789972').then( r => { 
              ...
              backwards.on('collect', r => { 
                 r.remove(message.author.id);
                    page--; 
                    if (page === 1) {
                        let ecoembed = new bot.discord.MessageEmbed()
                        .setColor('#FF00EC')
                        .addField('Economy Commands', `${prefix + economycommands.join(`\n ${prefix}`)}`)
                        .addField('Game Commands', `${prefix + games.join(`\n ${prefix}`)}`)
                        .setFooter(`Page ${page} of ${pages.length}`) 
...
//#endregion
//#region image
    } else if (arg === 'image' || cmd === ' <@460159835544092674> help image') {
        let pages = ['Image Help Menu', 'Image Commands Descriptions'];
        let page = 1;
        const imageembed = new bot.discord.MessageEmbed()
        .setColor('#FF00EC')
        .setTitle(pages[page-1])
            ...
            msg.react('614293189825789972').then( r => { 
              ...
              backwards.on('collect', r => { 
                r.remove(message.author.id);
                    page--; 
                    if (page === 1) {
                        let imageembed = new bot.discord.MessageEmbed()
                        .setColor('#FF00EC')
                        .addField('Image Commands', `${prefix}${imagecommands.join(`\n ${prefix}`)}`)
                        .addField('Gif Commands', `${prefix}${gifcommands.join(`\n ${prefix}`)}`)
                        .setFooter(`Page ${page} of ${pages.length}`) 
...
//#endregion
//#region music
    } else if (arg === 'music' || cmd === '<@460159835544092674> help music') {
        let pages = ['Music Help Menu', 'Music Commands Descriptions'];
        let page = 1;
        const musicembed = new bot.discord.MessageEmbed()
        .setColor('#FF00EC')
        .setTitle(pages[page-1])
            ...
            msg.react('614293189825789972').then( r => { 
              ...
              backwards.on('collect', r => {
                r.remove(message.author.id);
                    page--; 
                    if (page === 1) {
                        let musicembed = new bot.discord.MessageEmbed()
                        .setColor('#FF00EC')
                        .setDescription(`${prefix}${musiccommands.join(`\n ${prefix}`)}`)
                        .setFooter(`Page ${page} of ${pages.length}`) 
                        .setTitle(pages[page-1])
...
//#endregion
//#region songs
    } else if (arg === 'songs' || cmd === '<@460159835544092674> help songs') {
        let pages = ['Song list 1', 'Song list 2', 'Song list 3'];
        let page = 1;
        const songembed1 = new bot.discord.MessageEmbed()
        .setColor('#FF00EC')
        .setTitle(pages[page-1])
            ...
            msg.react('614293189825789972').then(r => { 
              ...
              backwards.on('collect', r => { 
                r.remove(message.author.id);
                    page--; 
                    if (page === 1) {
                        let songembed1 = new bot.discord.MessageEmbed()
                        .setColor('#FF00EC')
                        .setTitle(pages[page-1])
                        .setDescription(`${prefix}${songcommands.slice(0, 21).join(`\n ${prefix}`)}`)
                        .setFooter(`Page ${page} of ${pages.length}`)
                        ...
                        let songembed2 = new bot.discord.MessageEmbed()
                            .setTitle(pages[page-1])
                        ...
                        let songembed3 = new bot.discord.MessageEmbed()
                            .setTitle(pages[page-1])
