...
//#region songs
        ...
        let page = 1;
        const songembed1 = new discord.MessageEmbed()
        .setColor('#FF00EC')
        .setTitle(pages[page-1])
            ...
            msg.react('614293189825789972').then(r => { 
              ...
              backwards.on('collect', r => { 
                r.remove(message.author.id);
                    page--; 
                    if (page === 1) {
                        let songembed1 = new discord.MessageEmbed()
                        .setColor('#FF00EC')
                        .setTitle(pages[page-1])
                        .setDescription(`${prefix}${songcommands.slice(0, 21).join(`\n ${prefix}`)}`)
                        .setFooter(`Page ${page} of ${pages.length}`)
                        ...
                        let songembed2 = new discord.MessageEmbed()
                            .setTitle(pages[page-1])
                        ...
                        let songembed3 = new discord.MessageEmbed()
                            .setTitle(pages[page-1])
