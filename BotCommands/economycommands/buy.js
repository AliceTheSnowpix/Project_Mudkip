...
exports.run = async(bot, message, args) => {
  ...
  let input = message.content.slice(prefix.length).toLowerCase().split(' ').slice(1).join(' ');
    ...
    if(input === '12') 
      ...
      if (input === n1.split(' ').join(' ').toLowerCase()) {
      ...
      if (input === n2.split(' ').join(' ').toLowerCase()) {
      ...
      if (input === n3.split(' ').join(' ').toLowerCase()) {
      ...
      if (input === n4.split(' ').join(' ').toLowerCase()) {
      ...
      if (input === n5.split(' ').join(' ').toLowerCase()) {
      ...
      if (input === n6.split(' ').join(' ').toLowerCase()) {
      ...
      if (input === n7.split(' ').join(' ').toLowerCase()) {
      ...
      if (input === n8.split(' ').join(' ').toLowerCase()) {
      ...
      if (input === n9.split(' ').join(' ').toLowerCase()) {
      ...
      if (input === n10.split(' ').join(' ').toLowerCase()) {
